...
async function main() {
  ...
  console.log("Running partner skills scrape (per-source files)...");
  require("child_process").execFileSync(process.execPath, [path.join(__dirname, "scrape-partner-skills.js")], {
    stdio: "inherit",
    cwd: root,
  });
}
